...
export default function WalletFooter({ setActiveTab,activeTab }: WalletFooterProps ) {
  return (
    <div className="w-full h-full flex items-start  justify-center ">
    <ToggleGroup type="single" value={activeTab} onValueChange={setActiveTab} className="w-[60%]" >
