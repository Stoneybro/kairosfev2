...
const heading = {
  ...
  subtitle: "A user-friendly smart wallet that makes commitments auditable and self-executing.",
};
...
const featuresCardsList = {
  items: [
    ...
    },
    {
      ...
      image: {
        src: "/lockedwallet.jpg",
        alt: "Locked funds and task card",
      },
      characteristics: {
        items: [
          { _title: "Secure Funds" },
          { _title: "Timebound tasks" },
            ...
            <div className="flex flex-col gap-8 p-5 pt-6 md:flex-1 md:p-10">
              ...
              <ul className="flex flex-col items-start gap-3 pl-2 md:text-lg">
                {item.characteristics.items.map(({ _title }) => (
                  ...
                  >
                    <span className="flex size-6 items-center bg-foreground/10 justify-center rounded-full ">
